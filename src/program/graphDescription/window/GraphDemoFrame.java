package program.graphDescription.window;
...
public class GraphDemoFrame extends JFrame {
    ...
    private JTextArea secondTextAreaGraphFile;
    private JButton checkIsomorphismButton;
    private JPanel panelSecondGraphPainterContainer;
    private JButton buttonCreateSecondGraph;
    ...
    private SvgPanel panelSecondGraphPainter;
    ...
    public GraphDemoFrame() {
        ...
        panelSecondGraphPainterContainer.setLayout(new BorderLayout());
        panelSecondGraphPainter = new SvgPanel();
        panelSecondGraphPainterContainer.add(new JScrollPane(panelSecondGraphPainter));
        ...
        buttonCreateSecondGraph.addActionListener(e -> {
            try {
                String name = comboBoxGraphType.getSelectedItem().toString();
                Matcher matcher = Pattern.compile(".*\\W(\\w+)\\s*\\)\\s*$").matcher(name);
                matcher.find();
                String className = matcher.group(1);
                Class clz = Class.forName("program.graphDescription." + className);
                Graph graph = GraphUtils.fromStr(secondTextAreaGraphFile.getText(), clz);
                GraphDemoFrame.this.graph = graph;
                panelSecondGraphPainter.paint(dotToSvg(graph.toDot()));
            } catch (Exception exc) {
                SwingUtils.showErrorMessageBox(exc);
            }
        });
        checkIsomorphismButton.addActionListener(e -> {
            try {
                int[] previousFirstGraph = ArrayUtils.toIntArray(textAreaGraphFile.getText());
                int[] previousSecondGraph = ArrayUtils.toIntArray(secondTextAreaGraphFile.getText());
                Integer[] firstGraph = new Integer[previousFirstGraph.length - 2];
                Integer[] secondGraph = new Integer[previousSecondGraph.length - 2];
                for (int i = 2; i < previousFirstGraph.length; i++) {
                    firstGraph[i - 2] = previousFirstGraph[i];
                }
                for (int i = 2; i < previousSecondGraph.length; i++) {
                    secondGraph[i - 2] = previousSecondGraph[i];
                }
                graphBuilding.Graph.readRoads(firstGraph, secondGraph);
                graphBuilding.Graph.addFirstGraphRoads(firstGraph);
                graphBuilding.Graph.addSecondGraphRoads(secondGraph);
                if (graphBuilding.Graph.checkIsomorphism(firstGraph, secondGraph)) {
                    textAreaSystemOut.setText("Графы изоморфны");
                } else {
                    textAreaSystemOut.setText("Графы не изоморфны");
                }
            } catch (Exception exc) {
                SwingUtils.showErrorMessageBox(exc);
            }
...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        panelGraphTab.add(splitPaneGraphTab1, new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_BOTH, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, null, new Dimension(1048, 200), null, 0, false));
        ...
        buttonCreateGraph.setText("Построить первый граф");
        ...
        secondTextAreaGraphFile = new JTextArea();
        secondTextAreaGraphFile.setText("4\n4\n0 1\n0 2\n0 3\n2 3\n");
        panel1.add(secondTextAreaGraphFile, new GridConstraints(0, 1, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_BOTH, GridConstraints.SIZEPOLICY_WANT_GROW, GridConstraints.SIZEPOLICY_WANT_GROW, null, new Dimension(150, 50), null, 0, false));
        checkIsomorphismButton = new JButton();
        checkIsomorphismButton.setText("Проверить на изоморфность");
        panel1.add(checkIsomorphismButton, new GridConstraints(1, 1, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        buttonCreateSecondGraph = new JButton();
        buttonCreateSecondGraph.setText("Построить второй граф");
        panel1.add(buttonCreateSecondGraph, new GridConstraints(2, 1, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        ...
        panelGraphPainterContainer.setLayout(new GridLayoutManager(1, 1, new Insets(0, 0, 0, 0), -1, 10));
        panel7.add(panelGraphPainterContainer, new GridConstraints(0, 0, 1, 2, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_BOTH, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_WANT_GROW, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, null, new Dimension(1000, 600), null, 0, false));
        ...
        panelSecondGraphPainterContainer = new JPanel();
        panelSecondGraphPainterContainer.setLayout(new GridLayoutManager(1, 1, new Insets(0, 0, 0, 0), -1, 10));
        panel7.add(panelSecondGraphPainterContainer, new GridConstraints(0, 2, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_BOTH, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, null, new Dimension(800, 600), null, 0, false));
